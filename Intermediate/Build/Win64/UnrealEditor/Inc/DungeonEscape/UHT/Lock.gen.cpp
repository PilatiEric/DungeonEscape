...
struct Z_Construct_UClass_ALock_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_TriggerComp_MetaData[] = {
		...
		{ "Comment", "//This is what we'll be attaching everything else to\n" },
#endif
		{ "EditInline", "true" },
		{ "ModuleRelativePath", "Lock.h" },
#if !UE_BUILD_SHIPPING
		{ "ToolTip", "This is what we'll be attaching everything else to" },
#endif
	};
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_game_dev_unreal_CppCourseProjects_UnrealLessons_3_Dungeon_Escape_DungeonEscape_Source_DungeonEscape_Lock_h__Script_DungeonEscape_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_ALock, ALock::StaticClass, TEXT("ALock"), &Z_Registration_Info_UClass_ALock, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ALock), 2662749589U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_game_dev_unreal_CppCourseProjects_UnrealLessons_3_Dungeon_Escape_DungeonEscape_Source_DungeonEscape_Lock_h__Script_DungeonEscape_812719092(TEXT("/Script/DungeonEscape"),
	Z_CompiledInDeferFile_FID_game_dev_unreal_CppCourseProjects_UnrealLessons_3_Dungeon_Escape_DungeonEscape_Source_DungeonEscape_Lock_h__Script_DungeonEscape_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_game_dev_unreal_CppCourseProjects_UnrealLessons_3_Dungeon_Escape_DungeonEscape_Source_DungeonEscape_Lock_h__Script_DungeonEscape_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// ********** End Registration *********************************************************************
